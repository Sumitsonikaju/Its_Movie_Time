...
public partial class hall1_9am : System.Web.UI.Page
{
    OleDbCommand cmd;
    OleDbConnection con;
    OleDbDataAdapter da;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Session["mseat"] = HiddenField2.Value + HiddenField3.Value + HiddenField4.Value + HiddenField5.Value;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList1.Items)
        {
            ...
            {
                count1++;
                string r = "insert into mseat values('" + li.Text + "')";
